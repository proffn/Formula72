...
export const homePageMock: HomePageData = {
  ...
  coverageMap: {
    ...
    description: "Нам доверяют тысячи клиентов",
    mapImage: "/images/home/coverage-map/map.png",
    reviews: [
      {
        id: "coverage-review-1",
        name: "Елена",
        reviewText: "В восторге! Качество 100%. Самое лучшее производство.",
        rating: 5,
      ...
      },
      {
        ...
        name: "Дарья",
        reviewText: "Все понравилось! Спасибо менеджеру Ольге за сопровождение заказа.",
        rating: 5,
        avatar: "/images/home/coverage-map/default-avatar.png",
        xPosition: 18,
        yPosition: 56,
      ...
      },
      {
        ...
        name: "Анна",
        reviewText: "Быстро согласовали детали, помогли с упаковкой и получили отличный результат.",
        rating: 5,
        avatar: "/images/home/coverage-map/default-avatar.png",
        xPosition: 50,
        yPosition: 48,
      ...
      },
      {
        ...
        name: "Мария",
        reviewText: "Очень аккуратная работа с брендом и стабильное качество от партии к партии.",
        rating: 4,
        avatar: "/images/home/coverage-map/default-avatar.png",
        xPosition: 89,
        yPosition: 58,
