...
const endpoints = [
  ...
  ["workStages", "/api/work-stages-section?populate[stages][populate]=image"],
  ["whoSuits", "/api/who-suits-section?populate[items][populate]=image"],
  [
    "whyTrustUs",
    "/api/why-trust-us-section?populate[brandLinks]=*&populate[points]=*&populate[galleryItems][populate]=*",
  ],
  ["whatWeCanMake", "/api/what-we-can-make-section?populate[items][populate]=*"],
  ["coverageMap", "/api/coverage-map-section?populate=*"],
  ["faq", "/api/faq-section?populate[categories][populate]=items"],
